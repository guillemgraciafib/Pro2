...
private:
  ...
  /* 
     Invariant de la representació: (suposem que Estudiant::nota_maxima()=5)
     ...
     - nombre_compensables = nombre d'elements de vest[0..nest-1] amb nota estrictament menor que 5 i més gran o igual que 4
  */
