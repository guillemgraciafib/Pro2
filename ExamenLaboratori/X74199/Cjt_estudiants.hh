...
private:
  ...
  /* 
     ...
     - 0 <= pitjor_becat < nest si i nomes si max_beques>0 i hi ha cap estudiant
       a vest[0..nest-1] amb nota >= min_nota_beca; en cas afirmatiu, v[pitjor_becat] 
       es l'estudiant becat menys prioritari; en cas contrari, pitjor_becat=-1
  */
...
public:
  ...
  void llegir();
  /* Pre: estan preparats al canal estàndar d'entrada un enter no negatiu que
     representa el nombre maxim de beques a atorgar, un double entre 0 i la
     nota maxima de la classe Estudiant, que representa la nota minima per
     aspirar a beca i un enter en [0 .. Estudiant::nota_maxima()], que
     representa el nombre d'elements que llegirem, i les dades de tal nombre
     d'estudiants diferents */
