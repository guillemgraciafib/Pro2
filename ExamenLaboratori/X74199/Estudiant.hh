...
public:
  ...
  // Operacio nova: per saber si un estudiant té més prioritat que un altre
  // a l'hora de rebre una beca
  bool mes_prioritari(const Estudiant& e) const; 
  /* Pre: cert  */
  /* Post: el resultat indica si la nota del p.i. es més gran que la d'e; si
     son iguals, indica si el DNI del p.i. és més gran que el d'e */
